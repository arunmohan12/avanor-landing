...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const header = document.querySelector('.wadeem-header');
    const menuToggle = document.querySelector('.wadeem-menu-toggle');
    const mobileMenu = document.querySelector('.wadeem-mobile-menu');
    const mobileLinks = document.querySelectorAll('.wadeem-mobile-menu a');
    ...
    */
    ...
    const closeMenu = () => {
        ...
        document.body.classList.remove('wadeem-menu-open');
    };
    ...
    const openMenu = () => {
        ...
        document.body.classList.add('wadeem-menu-open');
    };
